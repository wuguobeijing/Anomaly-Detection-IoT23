...
def train_auto_gl():
    ...
    log = open("/media/wuguo-buaa/LENOVO_USB_HDD/PycharmProjects/Anomaly-Detection-IoT23/cloud_model.log", mode="a", encoding="utf-8")
...
if __name__ == '__main__':
    ...
    for message in consumer:
        ...
        if message.value["type"] == 'new_parquet':
            ...
            train_auto_gl()
            train_auto_gl_mul()
            make_targz('model.tar.gz', "/media/wuguo-buaa/LENOVO_USB_HDD/PycharmProjects/Anomaly-Detection-IoT23/Models"
                                       "/auto_gl/edge_model")
